...
- 状態（2026-09-05）: **app v0.21.0 まで完了**。5種のリズムとドラムだけモード、12キー＋ランダムのキー選択、メロディの重力、21種のスケール選択、数字キーSFX、音色4種とShift切替、
...
saw／pluck は2声のデチューンを左右へ分けるステレオユニゾンとして鳴る。
メインリバーブには、プリディレイ内の初期反射5本を追加している。
