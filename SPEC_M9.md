...
> **2026-09-04 更新（v0.16.0）**: 本人指示「アルペジオは1と6だけにしましょう」により、フレーズは **1度と6度の2音**へ変更した。
> 6度は音程基準（押した音から9半音に最も近い音階音、同距離は低い方）。`ARPEGGIO_GAINS` は `[1, 0.85]`。時刻は 0 と `beatSec/3` のまま。
> 以下の「1・3・5度の3連符」の記述は v0.10.0〜v0.15.0 の内容。
